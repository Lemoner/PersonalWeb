...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/resources/css/htmleaf-demo.css">
<link rel="stylesheet" type="text/css"
	href="https://cdnjs.cloudflare.com/ajax/libs/emojione/1.5.2/assets/sprites/emojione.sprites.css"
	media="screen">
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/resources/css/stylesheet.css"
	media="screen">
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/resources/css/emojionearea.min.css"
	media="screen">
<link
...
<body>
								...
								<div class="panel panel-default">
									...
									<div id="collapseOne" class="panel-collapse collapse in"
										...
										<div class="panel-body">
											<p id="listMoodText">${moodLog.moodText}</p>
											<p>
	...
	<script type="text/javascript"
		src="<%=request.getContextPath()%>/resources/js/emojionearea.js"></script>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$("#moodText").emojioneArea({
				template : "<filters/><tabs/><editor/>"
			});
			$("#listMoodText").emojioneArea({
